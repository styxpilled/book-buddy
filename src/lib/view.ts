...
import { extend, borders, uuid, isNumber, bounds, defer, qs, parse } from 'epubjs/src/utils/core';
...
class InlineView {
	...
	public settings: {
		...
		height: number;
		layout: undefined;
		globalLayoutProperties: Layout;
	};

	constructor(section: Section, options: BookOptions) {
